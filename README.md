...
| **위트** | "인간이 7명의 AI를 이길 수 있을까요? 젠장, 내가 스파이라도 헷갈리네!" |
...
* **AI 액션 로직 도입:** AI가 대화 기록을 바탕으로 스파이 지목 또는 장소 추측을 **스스로 판단**하도록 LLM 추론 모듈을 추가합니다. (완전한 자율 게임 진행)
* **질문 선택 최적화:** LLM이 대화 히스토리를 분석하여 질문 리스트 중 **가장 적절한 질문**을 선택하도록 로직을 변경합니다. (맥락 연결성 강화)
* **토큰 효율성:** Ollama의 **JSON 모드** 등을 활용하여 출력을 구조화하고 프롬프트 길이를 최적화합니다. (속도 및 안정성 개선)
